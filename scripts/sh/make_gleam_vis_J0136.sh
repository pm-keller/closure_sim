...
outfile="/users/pkeller/code/ClosureSim/data/vis_EQ28_J0136.h5"
/lustre/aoc/projects/hera/pkeller/anaconda3/bin/python3 "${pythonfile}" -g "${gleamfile}" -o "${outfile}" -b "${beamfile}" -a "${antfile}" --nf 1024 --fmin 100 --fmax 200 --nt 1 --tmin 1.600 --tmax 1.601
