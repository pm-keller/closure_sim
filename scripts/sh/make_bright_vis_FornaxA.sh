...
outfile="/users/pkeller/code/ClosureSim/data/vis_bright_EQ28_FornaxA.h5"
/lustre/aoc/projects/hera/pkeller/anaconda3/bin/python3 "${pythonfile}" -o "${outfile}" -b "${beamfile}" -a "${antfile}" --nf 1024 --fmin 100 --fmax 200 --nt 1 --tmin 3.366 --tmax 3.367
